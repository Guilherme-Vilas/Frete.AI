...
import CargaFormModal from './CargaFormModal'
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md border border-blue-200 dark:border-blue-700">
              ...
              <div className="space-y-3">
                <button 
                  ...
                  className="w-full px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-lg transition-all"
                >
                  + Nova Carga
                </button>
